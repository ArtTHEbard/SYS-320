...
Get-ChildItem -Recurse -include *.docx, *.pdf, *.xlsx -Path D:\Sec320\SYS-320\Week12\homework\Documents | Export-Csv 'D:\Sec320\SYS-320\Week12\homework\targets.csv'

# Import csv file
$filelist = import-csv -Path .\targets.csv -header FullName
