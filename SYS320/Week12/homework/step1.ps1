...
Copy-Item -Path 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe' -Destination 'D:\Sec320\SYS-320\Week12\homework\'
...
Rename-Item -Path 'D:\Sec320\SYS-320\Week12\homework\powershell.exe' -NewName $newname 

# Check to see if file exists. 
$testpath = 'D:\Sec320\SYS-320\Week12\homework\' + $newname
...
$file =  'D:\Sec320\SYS-320\Week12\homework\README;).READ'
$msg | Out-File -FilePath $file

# Check to see if file exists. 
$testpath = 'D:\Sec320\SYS-320\Week12\homework\' + 'README;).READ'
if (Test-Path -Path $testpath) {
    Write-Host -BackgroundColor "green" -ForegroundColor "black" "Good to Go"
} else {
    Write-Host -BackgroundColor "red" -ForegroundColor "black" "NO GO BOSS"
