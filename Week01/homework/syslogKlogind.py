# Code by Sam Johnson
# This code utilized the syslogCheck function to sort for users who failed to
# authenticated with Klogind. This is done by selecting a defined split target, and appending the
